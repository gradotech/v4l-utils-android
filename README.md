...
A copy of v4l-utils compatible with AOSP 14.
To compile media-ctl, for example, copy this project to **<AOSP_DIR>/external** and then do:

```bash
cd external/v4l-utils-android/utils/media-ctl
mm
```
